...
cp "$here"/wp/tools/apply-design-system.php "$here"/wp/tools/import-photo-focus.php "$here"/wp/tools/photo-focus.csv "$here"/wp/tools/check-editor-presets.php "$dest/tools/"
